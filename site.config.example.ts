// Copy thành src/config/site.ts (đã gitignore nếu muốn) — MỘT chỗ duy nhất chứa
// thông tin thương hiệu/liên hệ, mọi trang import từ đây.
//
// Lưu ý: đây là thông tin HIỂN THỊ CÔNG KHAI trên website (khách phải thấy SĐT
// mới gọi được) — nên "không lộ" ở đây nghĩa là không nằm rải rác trong code,
// chứ không phải ẩn khỏi người xem trang.
//
...
export const SITE = {
  ...
  // công ty nguồn hàng) — ví dụ: "Quà Tặng Trung Thu 5 Sao".
