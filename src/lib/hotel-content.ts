...
export const HOTEL_CONTENT: Record<string, HotelContent> = {
  ...
  renaissance: {
    tuVan:
      'Chỉ 2 mẫu, An Nhã (1.388k) kèm trà Kim Tuyên — lựa chọn gọn cho ngân sách 1,2–1,5tr; Bích Ngọc (1.988k) kèm quà tặng cao cấp cho khách VIP.',
    faqRieng: [
      {
  ...
  hilton: {
    tuVan:
      'Tea Version (1.688k) an toàn cho mọi đối tượng; Wine Version (2.180k) kèm quà tặng cao cấp cho đối tác thân.',
    faqRieng: [
      {
