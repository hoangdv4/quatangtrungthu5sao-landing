// Màu nhấn riêng từng khách sạn (viền hero, tag BST, hover) — khớp --color-brand-*
// khai báo trong src/styles/global.css. Dùng chung giữa trang chủ và trang con.
export const BRAND_TINT_BORDER: Record<string, string> = {
  marriott: 'border-brand-marriott',
  ...
  nikko: 'border-brand-nikko',
  renaissance: 'border-brand-renaissance',
};
